...
\begin{figure}[h]
\centering
\subfloat[Pre-computation in 1d  ]{
\includegraphics[width=0.5\linewidth]{figtkde/inex1dgen.png}
\label{dy:subfig1}
}\\
~~\subfloat[Pre-computation of set A]{
\includegraphics[width=0.22\linewidth]{figtkde/pre1db}
\label{prec:subfig2}
}
~~\subfloat[Pre-computation of set B]{
\includegraphics[width=0.22\linewidth]{figtkde/pre1da}
\label{prec:subfig3}
}
