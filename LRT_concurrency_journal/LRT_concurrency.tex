...
~~\subfloat[]{
\includegraphics[width=0.4\linewidth]{figtkde/fastspeed}
\label{fast:subfig2}
}
...
\caption{Speed-up of LRT computation on EC2 cloud cluster }\label{fast}
\end{figure}
%multi-core
\begin{figure}[h]
\centering
\subfloat[Speed-up and Efficiency of Grid (1000,1000) on Multi-core]{
\includegraphics[width=0.45\linewidth]{figtkde/speedup-efficiency}
\label{multicore:multicore1}
}
~~\subfloat[The number of rectangles processed per second vs. number of cores on Grid (1000,1000)]{
\includegraphics[width=0.4\linewidth]{figtkde/singlerectangle}
\label{multicore2}
}
...
\includegraphics[width=0.45\linewidth]{figtkde/multicore}
\label{multicore:speedup2}
}\\
~~\subfloat[The number of rectangles processed per second vs. number of cores on Grid (1000,1000)]{
\includegraphics[width=0.45\linewidth]{figtkde/singlerectangle}
...
\includegraphics[width=0.45\linewidth]{figtkde/norec_multicore}
